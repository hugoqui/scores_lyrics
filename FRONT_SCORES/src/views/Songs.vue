    ...
    <div class="container-fluid">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control m-1" v-model="newSong.chord"
                            placeholder="Acorde Base (ej: C)">
                        <textarea type="text" class="form-control m-1" v-model="newSong.lyrics" rows="10"
                            placeholder="Separe las estrofas con *"></textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" @click="modalVisible = false;"
                            data-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-primary" @click="modalVisible = false; createSong()"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control m-1" v-model="selectedSong.chord"
                            placeholder="Acorde Base (ej: C)">
                        <textarea type="text" class="form-control m-1" v-model="selectedSong.lyrics" rows="10"
                            placeholder="Separe las estrofas con *"></textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" @click="modalVisible = false;"
                            data-dismiss="modal">Cancelar</button>
                        <button type="button" class="btn btn-primary" @click="modalVisible = false; saveChanges()"
                            data-dismiss="modal">Guardar</button>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-2">
            ...
            <div class="col-4 mb-4" style="max-height:96vh; overflow:auto; ">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="input-group mb-3">
                            ...
                            <input v-model="searchedText" @keydown.enter="search()" type="text" class="form-control"
                ...
                <div class="row">
                    <div class="col-6">
                        <button @clikc="modalVisible = true" class="btn btn-outline-warning" data-toggle="modal"
                            data-target="#addNewModal">+ Agregar Nuevo</button>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-lg-4 col-md-6 col-sm-12" v-for="(song, i) in filteredSongs" style="padding: 8px;">
                        <SongItem @selected="addSong(song)" :type="'gold'" @edit="showSongDetails(song.id)"
                            :showEdit="true" :key="song.id" :song="song" />
            ...
            <div class="col-4" style="max-height:96vh; overflow:auto; ">
                ...
                <div class="row mt-3">
                    <div class="col-lg-4 col-md-6 col-sm-12" v-for="(song, i) in worshipList"
                        style="position: relative;">
                        <SongItem @selected="inputSong = song.lyrics; songTitle = song.title" @remove="removeFromList(i)"
                            @edit="showSongDetails(song.id)" :showEdit="true" :showDelete="true" :type="'dark'"
            ...
            <div class="col-4" style="max-height:96vh; overflow:auto; ">
                ...
                <div class="border p-3 m-3 rounded border border-warning white zoom paragraph"
                    v-for="(verse, i) in verses" :key="verse.id" :class="selectedVerse == i + 1 ? 'active' : ''"
                    style="cursor:pointer" @click="showVerse(verse, i)">
    ...
    methods: {
        ...
        showVerse(verse, i) {
            try {
                ...
                console.log("tratando de enviar a socket ... ", data)
                if (this.$socket && this.$socket.connected) {
                    console.log("Socket está conectado, emitiendo...");
                    this.$socket.emit("song_change", data);
                } else {
                    console.warn("Socket no está conectado, no se puede emitir");
                }                
            } catch (error) {
                console.error(error)
            }
