...
export class InstrumentsService {
  instruments = signal<Instrument[]>([
    ...
    { id: 2, label: 'Violin 1', path: 'violin1', },
    { id: 3, label: 'Violin 2', path: 'violin2', },
    { id: 4, label: 'Flauta 1', path: 'flute1', },
    { id: 5, label: 'Flauta 2', path: 'flute2', },
    { id: 6, label: 'Trompeta', path: 'trumpet', },
    { id: 8, label: 'Clarinete 1', path: 'clarinet1', },
    { id: 9, label: 'Clarinete 2', path: 'clarinet2', },
