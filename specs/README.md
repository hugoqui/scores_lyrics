...
**Siguiente:** `002-identidad-de-iglesia` cerrado: la iglesia existe, el
aislamiento entre congregaciones lo impone el motor y se verifica con pruebas
que intentan romperlo. Toca `003-panel-saas`, que está sin especificar —
empezar por su `spec.md`.
